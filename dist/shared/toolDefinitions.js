...
export function getToolDefinitions(options = { includeClean: true }) {
    ...
    const tools = [
        ...
        },
        {
            ...
            description: 'Start capturing logs from a simulator. Returns a session ID for stop_sim_log_cap. Optional console capture relaunches the app.',
            inputSchema: {
                type: 'object',
                properties: {
                    simulator_uuid: {
        ...
        {
            name: 'describe_ui',
            description: 'Return the accessibility hierarchy for the running simulator using AXe. Provides coordinates for automation.',
            inputSchema: {
                type: 'object',
                properties: {
                    simulator_uuid: {
        ...
        {
            name: 'tap',
            description: 'Tap at specific coordinates using AXe. Use describe_ui first to gather accurate positions.',
            inputSchema: {
                type: 'object',
                properties: {
                    simulator_uuid: {
        ...
        {
            name: 'swipe',
            description: 'Swipe from one coordinate to another using AXe. Coordinates are provided in simulator points.',
            inputSchema: {
                type: 'object',
                properties: {
                    simulator_uuid: {
