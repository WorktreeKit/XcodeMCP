...
export class BuildTools {
    ...
    static async _getAvailableSchemes(projectPath) {
        const script = `
      (function() {
        ${getWorkspaceByPathScript(projectPath)}
    ...
    static async _getAvailableDestinations(projectPath) {
        const script = `
      (function() {
        ${getWorkspaceByPathScript(projectPath)}
        if (!workspace) return [];
    ...
    static async _findXCResultFiles(projectPath) {
        const xcresultFiles = [];
        try {
     ...
     */
    static async findXCResults(projectPath) {
        const validationError = PathValidator.validateProjectPath(projectPath);
        if (validationError)
            return validationError;
        try {
     ...
     */
    static async _handleReplaceExistingBuildAlert() {
        const alertScript = `
      (function() {
        try {
